export function resolveConfigResource(category) {
    return {
        ...
        index_href: category === 'application' ? '/settings/application-configs' : '/settings/system-configs',
        create_href: category === 'application' ? '/settings/application-configs/create' : '/settings/system-configs/create',
