...
const resource = {
    ...
    index_href: '/admin/settings/application-configs',
    export_href: '/admin/settings/application-configs/export',
    create_href: '/admin/settings/application-configs/create',
