...
<template>
    <header class="border-b border-app-panel-border/45 bg-background/90 text-app-panel-foreground backdrop-blur">
        <div class="mx-auto flex w-full max-w-[1600px] items-center justify-between gap-5 px-5 py-3 lg:px-8 xl:px-10">
